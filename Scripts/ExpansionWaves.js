...
var sys101 = ["101-bell1", "101-bell2", "101-bell3", "101-bell4", "101-pwm1", "101-pwm2", "101-pwm3", "101-pwm4", "101-string2", "101-string3", "101-string4"];

var jx3p = ["BigJx", "DCO Piano", "Lfade", "Lil bass", "Round", "S&H", "Simple", "Slow One", "T Sync", "W Brass", "Wet", "harsh"];

var hybrids = ["1st", "Bell Source", "Belles", "Big", "BigElectric", "Drug Wave", "EP1", "EP2", "EP3", "Euro Organ", "GateAR", "Hard Bass", "Leap", "Lingo", "More Bell", "Odd Keys", "Rousing", "Sad Ring", "Scrd", "Simple Guitar", "Special K", "Tinkly", "eggcelent", "fat organ", "mr clicky", "mth", "nsty1", "nsty2", "pswp", "pulser", "sawd", "simr", "slowish", "swirly whirl", "walls"];

var kraftzwerg = ["BooBass", "CrazyLFO", "Gooey", "Log", "Magic Resin", "OChord", "organic.xml"];

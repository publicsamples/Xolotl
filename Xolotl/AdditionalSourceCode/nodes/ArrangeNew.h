...
DECLARE_PARAMETER_RANGE_STEP(Stages2_InputRange, 
                             1., 
                             32., 
                             1.);
DECLARE_PARAMETER_RANGE_STEP(Stages2_0Range, 
                             1., 
                             33., 
                             1.);

template <int NV>
using Stages2_0 = parameter::from0To1<ArrangeNew_impl::clone_forward8_t<NV>, 
                                      0, 
                                      Stages2_0Range>;

template <int NV>
using Stages2 = parameter::chain<Stages2_InputRange, Stages2_0<NV>>;
...
template <int NV> struct instance: public ArrangeNew_impl::ArrangeNew_t_<NV>
{
	...
	struct metadata
	{
		...
		SNEX_METADATA_ENCODED_PARAMETERS(1782)
		{
            ...
            0x7079, 0x0065, 0x0000, 0x8000, 0x003F, 0xC000, 0x0040, 0x8000, 
            0x003F, 0x8000, 0x003F, 0x8000, 0x5C3F, 0x0E00, 0x0000, 0x5300, 
            ...
            0x6853, 0x0000, 0x0000, 0x3F80, 0x0000, 0x4080, 0x0000, 0x4080, 

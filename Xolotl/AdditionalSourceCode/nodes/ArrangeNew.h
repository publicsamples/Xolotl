...
template <int NV> struct instance: public ArrangeNew_impl::ArrangeNew_t_<NV>
{
	...
	struct metadata
	{
		...
		SNEX_METADATA_ENCODED_PARAMETERS(1782)
		{
            ...
            0x7079, 0x0065, 0x0000, 0x8000, 0x003F, 0xC000, 0x0040, 0x0000, 
            0x0040, 0x8000, 0x003F, 0x8000, 0x5C3F, 0x0E00, 0x0000, 0x5300, 
            0x6168, 0x6570, 0x0000, 0x0000, 0x0000, 0x0000, 0x3F80, 0x1EB8, 
            0x3F05, 0x0000, 0x3F80, 0x0000, 0x0000, 0x005C, 0x000F, 0x0000, 
            ...
            0x0000, 0x3F80, 0x0000, 0x40A0, 0x0000, 0x3F80, 0x0000, 0x3F80, 
            ...
            0x6853, 0x7061, 0x0065, 0x0000, 0x0000, 0x0000, 0x8000, 0x143F, 
            0x47AE, 0x003F, 0x8000, 0x003F, 0x0000, 0x5C00, 0x1A00, 0x0000, 
            ...
            0x0040, 0x8000, 0x003F, 0x8000, 0x003F, 0x8000, 0x5C3F, 0x1C00, 
            ...
            0x0000, 0x0000, 0x0000, 0x9000, 0x0041, 0x3000, 0x0041, 0x8000, 
            ...
            0x8000, 0x003F, 0x0000, 0x0042, 0x8000, 0x0041, 0x8000, 0x003F, 
            ...
            0x8000, 0xCD3F, 0x0CCC, 0x003F, 0x8000, 0x003F, 0x0000, 0x5C00, 
            ...
            0x8000, 0x003F, 0xA000, 0x0040, 0x0000, 0x0040, 0x8000, 0x003F, 
            ...
            0x8000, 0xEC3F, 0x7851, 0x003F, 0x8000, 0x003F, 0x0000, 0x5C00, 
            ...
            0x0000, 0x0000, 0x3F80, 0x0000, 0x4200, 0x0000, 0x4080, 0x0000, 
            ...
            0x3F80, 0x0000, 0x4200, 0x0000, 0x4080, 0x0000, 0x3F80, 0x0000, 
            ...
            0x0000, 0x3F80, 0x0000, 0x4200, 0x0000, 0x40A0, 0x0000, 0x3F80, 
            ...
            0x0000, 0x0000, 0x0000, 0x0000, 0x3F80, 0x0A3D, 0x3ED7, 0x0000, 
	...
	instance()
	{
		...
		this->setParameterT(87, 4.);
		this->setParameterT(88, 4.);
		this->setParameterT(89, 4.);
		this->setParameterT(90, 1.);
		this->setParameterT(91, 5.);
		this->setParameterT(92, 0.28);
		this->setParameterT(93, 1.);
		this->setParameterT(94, 1.);
		this->setParameterT(95, 0.42);
		this->setParameterT(96, 0.58);

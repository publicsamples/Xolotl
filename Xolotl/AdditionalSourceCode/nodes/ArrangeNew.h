...
using no_midi6_t_ = container::chain<parameter::empty, 
                                     wrap::fix<1, core::empty>>;

using no_midi6_t = wrap::no_midi<no_midi6_t_>;
...
template <int NV>
using clone_cable12_cable_mod = parameter::cloned<parameter::plain<input_toggle32_t<NV>, 2>>;
template <int NV>
using clone_cable12_t = control::clone_cable<clone_cable12_cable_mod<NV>, 
                                             duplilogic::spread>;

template <int NV>
using clone_cable15_mod = parameter::from0To1<input_toggle32_t<NV>, 
                                              0, 
                                              clone_cable28_modRange>;

template <int NV>
using clone_cable15_t = control::clone_cable<parameter::cloned<clone_cable15_mod<NV>>, 
                                             duplilogic::fixed>;
...
using clone_child_t = container::chain<parameter::empty, 
                                       ...
                                       jdsp::jpanner<NV>>;
template <int NV>
using clone_t = wrap::clonesplit<clone_child_t<NV>, 32>;
...
DECLARE_PARAMETER_RANGE(FxtoGain_InputRange, 
                        ...
                        1.);
template <int NV>
using FxtoGain_1 = parameter::from0To1<ArrangeNew_impl::clone_cable12_t<NV>, 
                                       1, 
                                       ArrangeNew_impl::peak1_mod_0Range>;
...
using V5_0 = parameter::from0To1<ArrangeNew_impl::clone_cable9_t<NV>, 
                                 0, 
                                 ArrangeNew_impl::clone_cable32_modRange>;
...
using FxToPitchSprd = parameter::plain<ArrangeNew_impl::clone_cable20_t<NV>, 
                                       1>;
template <int NV>
using FxFilterSprd = parameter::plain<ArrangeNew_impl::clone_cable22_t<NV>, 
                                      1>;
template <int NV>
...
using FileGainSmooth = parameter::plain<ArrangeNew_impl::clone_forward14_t<NV>, 
                                        1>;
template <int NV>
using PitchSmooth = parameter::plain<ArrangeNew_impl::clone_cable30_t<NV>, 
                                     1>;
template <int NV>
...
template <int NV> struct instance: public ArrangeNew_impl::ArrangeNew_t_<NV>
{
	...
	struct metadata
	{
		...
		SNEX_METADATA_ENCODED_PARAMETERS(1782)
		{
            ...
            0x8000, 0x00BF, 0x8000, 0xAE3F, 0x2147, 0x003F, 0x8000, 0x003F, 
            0x0000, 0x5C00, 0x0200, 0x0000, 0x4800, 0x7261, 0x536D, 0x6372, 
            0x0000, 0x0000, 0x3F80, 0x0000, 0x40A0, 0x0000, 0x4080, 0x0000, 
            ...
            0x0041, 0xE000, 0x0040, 0x8000, 0x003F, 0x8000, 0x5C3F, 0x0700, 
            0x0000, 0x5300, 0x6574, 0x0070, 0x0000, 0x0000, 0x0000, 0x8000, 
            0x003F, 0x8000, 0x003F, 0x8000, 0x003F, 0x0000, 0x5C00, 0x0800, 
            0x0000, 0x4400, 0x7465, 0x6E75, 0x0065, 0x0000, 0x8000, 0x00BF, 
            0x8000, 0x0A3F, 0x23D7, 0x003C, 0x8000, 0x003F, 0x0000, 0x5C00, 
            ...
            0x3F80, 0x45A2, 0x3AAA, 0x0000, 0x3F80, 0x0000, 0x0000, 0x005C, 
            ...
            0x7079, 0x0065, 0x0000, 0x8000, 0x003F, 0xC000, 0x0040, 0x4000, 
            0x0040, 0x8000, 0x003F, 0x8000, 0x5C3F, 0x0E00, 0x0000, 0x5300, 
            0x6168, 0x6570, 0x0000, 0x0000, 0x0000, 0x0000, 0x3F80, 0xC28F, 
            0x3CF5, 0x0000, 0x3F80, 0x0000, 0x0000, 0x005C, 0x000F, 0x0000, 
            0x6853, 0x7061, 0x4D65, 0x646F, 0x0000, 0x0000, 0xBF80, 0x0000, 
            0x3F80, 0xD70A, 0x3E23, 0x0000, 0x3F80, 0x0000, 0x0000, 0x005C, 
            ...
            0x0040, 0x4000, 0x0040, 0x8000, 0x003F, 0x8000, 0x5C3F, 0x1300, 
            0x0000, 0x5600, 0x696F, 0x6563, 0x6F4D, 0x6564, 0x0000, 0x0000, 
            0x3F80, 0x0000, 0x4040, 0xBB12, 0x3FB9, 0x0000, 0x3F80, 0x0000, 
            ...
            0xEC3F, 0xB851, 0x003D, 0x8000, 0x003F, 0x0000, 0x5C00, 0x1600, 
            ...
            0x6853, 0x7061, 0x0065, 0x0000, 0x0000, 0x0000, 0x8000, 0x9A3F, 
            0x5999, 0x003F, 0x8000, 0x003F, 0x0000, 0x5C00, 0x1A00, 0x0000, 
            ...
            0x3F80, 0x0000, 0x3F80, 0x0000, 0x0000, 0x005C, 0x002E, 0x0000, 
            ...
            0x8000, 0x853F, 0x51EB, 0x003F, 0x8000, 0x003F, 0x0000, 0x5C00, 
            ...
            0x5378, 0x6372, 0x0000, 0x0000, 0x3F80, 0x0000, 0x40C0, 0x0000, 
            0x3F80, 0x0000, 0x3F80, 0x0000, 0x3F80, 0x005C, 0x0034, 0x0000, 
            ...
            0x0000, 0xBF80, 0x0000, 0x3F80, 0x0000, 0x3F00, 0x0000, 0x3F80, 
            ...
            0x6E69, 0x0000, 0x0000, 0xBF80, 0x0000, 0x3F80, 0x0000, 0x0000, 
            0x0000, 0x3F80, 0x0000, 0x0000, 0x005C, 0x003C, 0x0000, 0x6E45, 
            0x5476, 0x6D65, 0x6F70, 0x0031, 0x0000, 0x0000, 0x0000, 0x9000, 
            0x0041, 0x1000, 0x0041, 0x8000, 0x003F, 0x8000, 0x5C3F, 0x3D00, 
            ...
            0x0000, 0x1C40, 0x0046, 0x062C, 0x7246, 0x4A6A, 0xCD3E, 0xCCCC, 
            0x5C3D, 0x3F00, 0x0000, 0x4500, 0x766E, 0x3144, 0x0000, 0x0000, 
            0x0000, 0x4000, 0x461C, 0x799A, 0x44E3, 0x6A72, 0x3E4A, 0xCCCD, 
            ...
            0x0000, 0x0000, 0x0000, 0x3F80, 0x47AE, 0x3DE1, 0x0000, 0x3F80, 
            0x0000, 0x0000, 0x005C, 0x0042, 0x0000, 0x6E45, 0x5276, 0x0031, 
            0x0000, 0x0000, 0x0000, 0x1C40, 0x0046, 0x0C2C, 0x7246, 0x4A6A, 
            0xCD3E, 0xCCCC, 0x5C3D, 0x4300, 0x0000, 0x4500, 0x766E, 0x7254, 
            0x6769, 0x0031, 0x0000, 0x0000, 0x0000, 0x8000, 0x003F, 0x0000, 
            0x0000, 0x8000, 0x003F, 0x8000, 0x5C3F, 0x4400, 0x0000, 0x4500, 
            ...
            0x0000, 0x0000, 0x1C40, 0x3346, 0x1233, 0x7244, 0x4A6A, 0xCD3E, 
            ...
            0x0000, 0x0000, 0x0000, 0x8000, 0x293F, 0x8F5C, 0x003E, 0x8000, 
            0x003F, 0x0000, 0x5C00, 0x4A00, 0x0000, 0x4500, 0x766E, 0x3252, 
            0x0000, 0x0000, 0x0000, 0x4000, 0x461C, 0x0000, 0x0000, 0x6A72, 
            ...
            0x7453, 0x6761, 0x7365, 0x0032, 0x0000, 0x8000, 0x003F, 0x0000, 
            ...
            0x6F6F, 0x6874, 0x0000, 0x0000, 0x0000, 0x0000, 0x3F80, 0x0000, 
	...
	instance()
	{
		...
		auto& no_midi6 = this->getT(0).getT(1).getT(2).getT(0).getT(1);                        // ArrangeNew_impl::no_midi6_t
		auto& no_midi13 = this->getT(0).getT(1).getT(2).getT(0).getT(2);                       // ArrangeNew_impl::no_midi13_t<NV>
		auto& split19 = this->getT(0).getT(1).getT(2).getT(0).getT(2).getT(0);                 // ArrangeNew_impl::split19_t<NV>
		auto& clone_cable2 = this->getT(0).getT(1).getT(2).getT(0).getT(2).getT(0).getT(0);    // ArrangeNew_impl::clone_cable2_t<NV>
		auto& clone_cable23 = this->getT(0).getT(1).getT(2).getT(0).getT(2).getT(0).getT(1);   // ArrangeNew_impl::clone_cable23_t<NV>
		auto& clone_cable24 = this->getT(0).getT(1).getT(2).getT(0).getT(2).getT(0).getT(2);   // ArrangeNew_impl::clone_cable24_t<NV>
		...
		auto& clone_cable1 = this->getT(0).getT(2).getT(0).getT(0).                          // ArrangeNew_impl::clone_cable1_t<NV>
                             getT(1).getT(3).getT(4).getT(0).
                             getT(0);
		auto& clone_cable12 = this->getT(0).getT(2).getT(0).getT(0).                         // ArrangeNew_impl::clone_cable12_t<NV>
                              getT(1).getT(3).getT(4).getT(0).
                              getT(1);
		auto& clone_cable15 = this->getT(0).getT(2).getT(0).getT(0).                         // ArrangeNew_impl::clone_cable15_t<NV>
                              getT(1).getT(3).getT(4).getT(0).
                              getT(2);
		...
		auto& FxtoGain_p = this->getParameterT(59);
		FxtoGain_p.connectT(0, clone_cable1);  // FxtoGain -> clone_cable1::Value
		FxtoGain_p.connectT(1, clone_cable12); // FxtoGain -> clone_cable12::Value
		...
		;                                   // clone_cable20::Value is automated
		...
		;                                   // clone_cable22::Value is automated
		...
		this->setParameterT(8, 0.01);
		this->setParameterT(9, 0.);
		this->setParameterT(10, 1.);
		this->setParameterT(11, 0.00129907);
		this->setParameterT(12, 1.);
		this->setParameterT(13, 3.);
		this->setParameterT(14, 0.03);
		this->setParameterT(15, 0.16);
		this->setParameterT(16, 2.);
		this->setParameterT(17, 0.);
		this->setParameterT(18, 3.);
		this->setParameterT(19, 1.45102);
		this->setParameterT(20, 0.);
		this->setParameterT(21, 0.09);
		...
		this->setParameterT(87, 16.);
		this->setParameterT(88, 16.);
		this->setParameterT(89, 16.);
		this->setParameterT(90, 0.);
		this->setParameterT(91, 17.);
		this->setParameterT(92, 0.5);
		this->setParameterT(93, 0.);
		this->setParameterT(94, 0.);
		this->setParameterT(95, 0.5);

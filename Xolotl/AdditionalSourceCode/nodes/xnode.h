...
using sliderbank_c1 = parameter::chain<ranges::Identity, 
                                       ...
                                       parameter::plain<oscillator7_t<NV>, 4>>;
...
using tempo_sync4_t = wrap::mod<parameter::plain<converter1_t<NV>, 0>, 
                                control::tempo_sync<NV>>;
DECLARE_PARAMETER_RANGE_STEP(sliderbank_c4_0Range, 
                             1., 
                             32., 
                             1.);

template <int NV>
using sliderbank_c4_0 = parameter::from0To1<tempo_sync3_t<NV>, 
                                            1, 
                                            sliderbank_c4_0Range>;

template <int NV>
using sliderbank_c4_1 = parameter::from0To1<tempo_sync4_t<NV>, 
                                            1, 
                                            sliderbank_c4_0Range>;
...
template <int NV>
using sliderbank1_c2 = parameter::from0To1<tempo_sync1_t<NV>, 
                                           1, 
                                           sliderbank_c4_0Range>;
...
template <int NV> struct instance: public xnode_impl::xnode_t_<NV>
{
	...
	struct metadata
	{
		...
		SNEX_METADATA_ENCODED_PARAMETERS(260)
		{
            ...
            0x0000, 0x0000, 0x0000, 0x4100, 0x0000, 0x40C0, 0x0000, 0x3F80, 
            ...
            0x0000, 0x8000, 0x003F, 0x0000, 0x0042, 0x8000, 0x0041, 0x8000, 
	...
	instance()
	{
		...
		auto& sliderbank = this->getT(0).getT(0);                                           // xnode_impl::sliderbank_t<NV>
		auto& modchain1 = this->getT(0).getT(1);                                            // xnode_impl::modchain1_t<NV>
		auto& minmax = this->getT(0).getT(1).getT(0);                                       // xnode_impl::minmax_t<NV>
		auto& pma_unscaled = this->getT(0).getT(1).getT(1);                                 // xnode_impl::pma_unscaled_t<NV>
		auto& midi_cc = this->getT(0).getT(1).getT(2);                                      // xnode_impl::midi_cc_t<NV>
		auto& pma_unscaled2 = this->getT(0).getT(1).getT(3);                                // xnode_impl::pma_unscaled2_t<NV>
		auto& pma_unscaled1 = this->getT(0).getT(1).getT(4);                                // xnode_impl::pma_unscaled1_t<NV>
		auto& modchain3 = this->getT(0).getT(2);                                            // xnode_impl::modchain3_t<NV>
		auto& tempo_sync1 = this->getT(0).getT(2).getT(0);                                  // xnode_impl::tempo_sync1_t<NV>
		auto& ramp = this->getT(0).getT(2).getT(1);                                         // xnode_impl::ramp_t<NV>
		auto& branch1 = this->getT(0).getT(2).getT(2);                                      // xnode_impl::branch1_t<NV>
		auto& chain8 = this->getT(0).getT(2).getT(2).getT(0);                               // xnode_impl::chain8_t
		auto& chain13 = this->getT(0).getT(2).getT(2).getT(1);                              // xnode_impl::chain13_t<NV>
		auto& pi = this->getT(0).getT(2).getT(2).getT(1).getT(0);                           // math::pi<NV>
		auto& sin = this->getT(0).getT(2).getT(2).getT(1).getT(1);                          // math::sin<NV>
		auto& peak1 = this->getT(0).getT(2).getT(3);                                        // xnode_impl::peak1_t<NV>
		auto& pma1 = this->getT(0).getT(2).getT(4);                                         // xnode_impl::pma1_t<NV>
		auto& sliderbank1 = this->getT(0).getT(2).getT(5);                                  // xnode_impl::sliderbank1_t<NV>
		auto& pma3 = this->getT(0).getT(2).getT(6);                                         // xnode_impl::pma3_t<NV>
		auto& chain9 = this->getT(0).getT(3);                                               // xnode_impl::chain9_t<NV>
		auto& branch = this->getT(0).getT(3).getT(0);                                       // xnode_impl::branch_t<NV>
		auto& chain21 = this->getT(0).getT(3).getT(0).getT(0);                              // xnode_impl::chain21_t<NV>
		auto& oscillator = this->getT(0).getT(3).getT(0).getT(0).getT(0);                   // xnode_impl::oscillator_t<NV>
		auto& chain25 = this->getT(0).getT(3).getT(0).getT(1);                              // xnode_impl::chain25_t<NV>
		auto& oscillator2 = this->getT(0).getT(3).getT(0).getT(1).getT(0);                  // xnode_impl::oscillator2_t<NV>
		auto& chain24 = this->getT(0).getT(3).getT(0).getT(2);                              // xnode_impl::chain24_t<NV>
		auto& oscillator1 = this->getT(0).getT(3).getT(0).getT(2).getT(0);                  // xnode_impl::oscillator1_t<NV>
		auto& chain23 = this->getT(0).getT(3).getT(0).getT(3);                              // xnode_impl::chain23_t<NV>
		auto& oscillator3 = this->getT(0).getT(3).getT(0).getT(3).getT(0);                  // xnode_impl::oscillator3_t<NV>
		auto& chain14 = this->getT(0).getT(3).getT(0).getT(4);                              // xnode_impl::chain14_t<NV>
		auto& modchain4 = this->getT(0).getT(3).getT(0).getT(4).getT(0);                    // xnode_impl::modchain4_t<NV>
		auto& pma2 = this->getT(0).getT(3).getT(0).getT(4).getT(0).getT(0);                 // xnode_impl::pma2_t<NV>
		auto& cable_table = this->getT(0).getT(3).getT(0).getT(4).getT(0).getT(1);          // xnode_impl::cable_table_t<NV>
		auto& cable_table1 = this->getT(0).getT(3).getT(0).getT(4).getT(0).getT(2);         // xnode_impl::cable_table1_t<NV>
		auto& oscillator4 = this->getT(0).getT(3).getT(0).getT(4).getT(1);                  // xnode_impl::oscillator4_t<NV>
		auto& one_pole = this->getT(0).getT(3).getT(0).getT(4).getT(2);                     // filters::one_pole<NV>
		auto& one_pole1 = this->getT(0).getT(3).getT(0).getT(4).getT(3);                    // filters::one_pole<NV>
		auto& chain26 = this->getT(0).getT(3).getT(0).getT(5);                              // xnode_impl::chain26_t<NV>
		auto& file_player = this->getT(0).getT(3).getT(0).getT(5).getT(0);                  // xnode_impl::file_player_t<NV>
		auto& chain16 = this->getT(0).getT(3).getT(0).getT(6);                              // xnode_impl::chain16_t<NV>
		auto& fix8_block = this->getT(0).getT(3).getT(0).getT(6).getT(0);                   // xnode_impl::fix8_block_t<NV>
		auto& tempo_sync3 = this->getT(0).getT(3).getT(0).getT(6).getT(0).getT(0);          // xnode_impl::tempo_sync3_t<NV>
		auto& converter = this->getT(0).getT(3).getT(0).getT(6).getT(0).getT(1);            // xnode_impl::converter_t<NV>
		auto& split2 = this->getT(0).getT(3).getT(0).getT(6).getT(0).getT(2);               // xnode_impl::split2_t<NV>
		auto& soft_bypass2 = this->getT(0).getT(3).getT(0).getT(6).getT(0).getT(2).getT(0); // xnode_impl::soft_bypass2_t<NV>
		auto& oscillator6 = this->getT(0).getT(3).getT(0).getT(6).                          // xnode_impl::oscillator6_t<NV>
                            getT(0).getT(2).getT(0).getT(0);
		auto& smoothed_parameter2 = this->getT(0).getT(3).getT(0).getT(6).                  // xnode_impl::smoothed_parameter2_t<NV>
                                    getT(0).getT(2).getT(0).getT(1);
		auto& add = this->getT(0).getT(3).getT(0).getT(6).                                  // math::add<NV>
                    getT(0).getT(2).getT(0).getT(2);
		auto& file_player1 = this->getT(0).getT(3).getT(0).getT(6).                         // xnode_impl::file_player1_t<NV>
                             getT(0).getT(2).getT(0).getT(3);
		auto& chain19 = this->getT(0).getT(3).getT(0).getT(7);                              // xnode_impl::chain19_t<NV>
		auto& fix8_block4 = this->getT(0).getT(3).getT(0).getT(7).getT(0);                  // xnode_impl::fix8_block4_t<NV>
		auto& tempo_sync4 = this->getT(0).getT(3).getT(0).getT(7).getT(0).getT(0);          // xnode_impl::tempo_sync4_t<NV>
		auto& converter1 = this->getT(0).getT(3).getT(0).getT(7).getT(0).getT(1);           // xnode_impl::converter1_t<NV>
		auto& split4 = this->getT(0).getT(3).getT(0).getT(7).getT(0).getT(2);               // xnode_impl::split4_t<NV>
		auto& soft_bypass3 = this->getT(0).getT(3).getT(0).getT(7).getT(0).getT(2).getT(0); // xnode_impl::soft_bypass3_t<NV>
		auto& no_midi = this->getT(0).getT(3).getT(0).getT(7).                              // xnode_impl::no_midi_t<NV>
                        getT(0).getT(2).getT(0).getT(0);
		auto& oscillator7 = this->getT(0).getT(3).getT(0).getT(7).                          // xnode_impl::oscillator7_t<NV>
                            getT(0).getT(2).getT(0).getT(0).
                            getT(0);
		auto& smoothed_parameter1 = this->getT(0).getT(3).getT(0).getT(7).                  // xnode_impl::smoothed_parameter1_t<NV>
                                    getT(0).getT(2).getT(0).getT(0).
                                    getT(1);
		auto& add1 = this->getT(0).getT(3).getT(0).getT(7).                                 // math::add<NV>
                     getT(0).getT(2).getT(0).getT(0).
                     getT(2);
		auto& file_player2 = this->getT(0).getT(3).getT(0).getT(7).                         // xnode_impl::file_player2_t<NV>
                             getT(0).getT(2).getT(0).getT(0).
                             getT(3);
		auto& chain20 = this->getT(0).getT(3).getT(0).getT(8);                              // xnode_impl::chain20_t<NV>
		auto& fix8_block5 = this->getT(0).getT(3).getT(0).getT(8).getT(0);                  // xnode_impl::fix8_block5_t<NV>
		auto& split5 = this->getT(0).getT(3).getT(0).getT(8).getT(0).getT(0);               // xnode_impl::split5_t<NV>
		auto& soft_bypass5 = this->getT(0).getT(3).getT(0).getT(8).getT(0).getT(0).getT(0); // xnode_impl::soft_bypass5_t<NV>
		auto& oscillator8 = this->getT(0).getT(3).getT(0).getT(8).                          // xnode_impl::oscillator8_t<NV>
                            getT(0).getT(0).getT(0).getT(0);
		auto& smoothed_parameter = this->getT(0).getT(3).getT(0).getT(8).            // xnode_impl::smoothed_parameter_t<NV>
                                   getT(0).getT(0).getT(0).getT(1);
		auto& add2 = this->getT(0).getT(3).getT(0).getT(8).                          // math::add<NV>
                     getT(0).getT(0).getT(0).getT(2);
		auto& file_player3 = this->getT(0).getT(3).getT(0).getT(8).                  // xnode_impl::file_player3_t<NV>
                             getT(0).getT(0).getT(0).getT(3);
		auto& chain1 = this->getT(0).getT(4);                                        // xnode_impl::chain1_t<NV>
		auto& xfader = this->getT(0).getT(4).getT(0);                                // xnode_impl::xfader_t<NV>
		auto& split = this->getT(0).getT(4).getT(1);                                 // xnode_impl::split_t<NV>
		auto& chain2 = this->getT(0).getT(4).getT(1).getT(0);                        // xnode_impl::chain2_t<NV>
		auto& gain = this->getT(0).getT(4).getT(1).getT(0).getT(0);                  // core::gain<NV>
		auto& chain3 = this->getT(0).getT(4).getT(1).getT(1);                        // xnode_impl::chain3_t<NV>
		auto& modchain = this->getT(0).getT(4).getT(1).getT(1).getT(0);              // xnode_impl::modchain_t<NV>
		auto& tempo_sync = this->getT(0).getT(4).getT(1).getT(1).getT(0).getT(0);    // xnode_impl::tempo_sync_t<NV>
		auto& chain7 = this->getT(0).getT(4).getT(1).getT(1).getT(1);                // xnode_impl::chain7_t<NV>
		auto& sampleandhold = this->getT(0).getT(4).getT(1).getT(1).getT(1).getT(0); // fx::sampleandhold<NV>
		auto& peak = this->getT(0).getT(4).getT(1).getT(1).getT(2);                  // xnode_impl::peak_t<NV>
		auto& gain1 = this->getT(0).getT(4).getT(1).getT(1).getT(3);                 // core::gain<NV>
		auto& chain4 = this->getT(0).getT(5);                                        // xnode_impl::chain4_t<NV>
		auto& xfader1 = this->getT(0).getT(5).getT(0);                               // xnode_impl::xfader1_t<NV>
		auto& split1 = this->getT(0).getT(5).getT(1);                                // xnode_impl::split1_t<NV>
		auto& chain5 = this->getT(0).getT(5).getT(1).getT(0);                        // xnode_impl::chain5_t<NV>
		auto& gain2 = this->getT(0).getT(5).getT(1).getT(0).getT(0);                 // core::gain<NV>
		auto& chain6 = this->getT(0).getT(5).getT(1).getT(1);                        // xnode_impl::chain6_t<NV>
		auto& modchain2 = this->getT(0).getT(5).getT(1).getT(1).getT(0);             // xnode_impl::modchain2_t<NV>
		auto& pma = this->getT(0).getT(5).getT(1).getT(1).getT(0).getT(0);           // xnode_impl::pma_t<NV>
		auto& branch2 = this->getT(0).getT(5).getT(1).getT(1).getT(1);               // xnode_impl::branch2_t<NV>
		auto& svf = this->getT(0).getT(5).getT(1).getT(1).getT(1).getT(0);           // filters::svf<NV>
		auto& svf2 = this->getT(0).getT(5).getT(1).getT(1).getT(1).getT(1);          // filters::svf<NV>
		auto& svf1 = this->getT(0).getT(5).getT(1).getT(1).getT(1).getT(2);          // filters::svf<NV>
		auto& faust3 = this->getT(0).getT(5).getT(1).getT(1).getT(1).getT(3);        // project::Comb<NV>
		auto& gain3 = this->getT(0).getT(5).getT(1).getT(1).getT(2);                 // core::gain<NV>
		...
		sliderbank_p.getParameterT(1).connectT(1, oscillator8);                     // sliderbank -> oscillator8::Phase
		sliderbank_p.getParameterT(1).connectT(2, oscillator7);                     // sliderbank -> oscillator7::Phase
		...
		sliderbank_p.getParameterT(4).connectT(0, tempo_sync3);                     // sliderbank -> tempo_sync3::Multiplier
		sliderbank_p.getParameterT(4).connectT(1, tempo_sync4);                     // sliderbank -> tempo_sync4::Multiplier
		...
		sliderbank1_p.getParameterT(2).connectT(0, tempo_sync1);         // sliderbank1 -> tempo_sync1::Multiplier
		...
		oscillator6.setParameterT(1, 28.6); // core::oscillator::Frequency
		...
		file_player1.setParameterT(3, 0.99); // core::file_player::FreqRatio
		...
		;                                 // oscillator7::Phase is automated
	...
	void setExternalData(const ExternalData& b, int index)
	{
		...
		this->getT(0).getT(0).setExternalData(b, index);                                 // xnode_impl::sliderbank_t<NV>
		this->getT(0).getT(2).getT(1).setExternalData(b, index);                         // xnode_impl::ramp_t<NV>
		this->getT(0).getT(2).getT(3).setExternalData(b, index);                         // xnode_impl::peak1_t<NV>
		this->getT(0).getT(2).getT(5).setExternalData(b, index);                         // xnode_impl::sliderbank1_t<NV>
		this->getT(0).getT(3).getT(0).getT(0).getT(0).setExternalData(b, index);         // xnode_impl::oscillator_t<NV>
		this->getT(0).getT(3).getT(0).getT(1).getT(0).setExternalData(b, index);         // xnode_impl::oscillator2_t<NV>
		this->getT(0).getT(3).getT(0).getT(2).getT(0).setExternalData(b, index);         // xnode_impl::oscillator1_t<NV>
		this->getT(0).getT(3).getT(0).getT(3).getT(0).setExternalData(b, index);         // xnode_impl::oscillator3_t<NV>
		this->getT(0).getT(3).getT(0).getT(4).getT(0).getT(1).setExternalData(b, index); // xnode_impl::cable_table_t<NV>
		this->getT(0).getT(3).getT(0).getT(4).getT(0).getT(2).setExternalData(b, index); // xnode_impl::cable_table1_t<NV>
		this->getT(0).getT(3).getT(0).getT(4).getT(1).setExternalData(b, index);         // xnode_impl::oscillator4_t<NV>
		this->getT(0).getT(3).getT(0).getT(5).getT(0).setExternalData(b, index);         // xnode_impl::file_player_t<NV>
		this->getT(0).getT(3).getT(0).getT(6).                                           // xnode_impl::oscillator6_t<NV>
        getT(0).getT(2).getT(0).getT(0).setExternalData(b, index);
		this->getT(0).getT(3).getT(0).getT(6).                                   // xnode_impl::file_player1_t<NV>
        getT(0).getT(2).getT(0).getT(3).setExternalData(b, index);
		this->getT(0).getT(3).getT(0).getT(7).                                   // xnode_impl::oscillator7_t<NV>
        getT(0).getT(2).getT(0).getT(0).
        getT(0).setExternalData(b, index);
		this->getT(0).getT(3).getT(0).getT(7).                                   // xnode_impl::file_player2_t<NV>
        getT(0).getT(2).getT(0).getT(0).
        getT(3).setExternalData(b, index);
		this->getT(0).getT(3).getT(0).getT(8).                                   // xnode_impl::oscillator8_t<NV>
        getT(0).getT(0).getT(0).getT(0).setExternalData(b, index);
		this->getT(0).getT(3).getT(0).getT(8).                                   // xnode_impl::file_player3_t<NV>
        getT(0).getT(0).getT(0).getT(3).setExternalData(b, index);
		this->getT(0).getT(4).getT(1).getT(1).getT(2).setExternalData(b, index); // xnode_impl::peak_t<NV>
	}
};
}

var MiscWaves = ["CS-Sine","CS-Pulse1","CS-Pulse2","CS-Pulse3","CS-Saw", "CS-Noise","CS-Noise2","CS-Noise3","CS-Noise4","Cy2OP1","Cy2OP2", "Dark BP", "Fold DF 1","Fold DF 2","HR Sqr", "LP Square","Shape1", "Shape2","Shape3","Shape4", "ZstringA", "ZstringB-ST", "RavST", "BlowyST", "CupCakeST", "GravelST", "DF1ST", "DF2ST", "CsShockST", "OgSlyST", "OgRadioST", "OgdfST", "GreatST", "CrunchyST"];
...
var Xpander = ["2 Fingers", "AV", "Another Time", "B Chord 1", "B Chord 2", "Bison1ST", "Bison2ST", "Boring Bass 1", "Boring Bass 2", "BugST", "E Kee 1", "E Kee 2", "Low Standards", "M Chord ST", "OChord", "Phase Pad", "StackST", "Thick Snappy 1", "Thick Snappy 2", "Thin Shine 1", "TubeS 1", "lose", "melomod", "osc mod", "FMThick1", "FMThick2", "FMThick3", "FMThick4", "FmDrama1ST", "FmDrama2ST"];
